package com.example.administrator.everywherretrip.widget;
...
import com.example.administrator.everywherretrip.util.SystemUtil;
...
public class PreviewIndicator extends LinearLayout {
    ...
    private void setNomalState(ImageView imageView) {
        imageView.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.bg_e0e0e0_r6));
